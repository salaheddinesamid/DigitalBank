...
from .views import AccountCreationView, AccountRequestList, AccountOpeningRequestUpdate, AccountDetailView, BankAccountDepositView, BankAccountWithdrawView

urlpatterns = [
    path('accounts/new', AccountCreationView.as_view()),
    path('accounts/get', AccountDetailView.as_view()),
    path('accounts/deposit', BankAccountDepositView.as_view()),
    path('accounts/withdraw', BankAccountWithdrawView.as_view()),
